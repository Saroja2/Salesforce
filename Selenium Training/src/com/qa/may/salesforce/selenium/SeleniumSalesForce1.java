...
public class SeleniumSalesForce1 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		logger =reports.startTest("SFDCLogin TestCase_1");
	...
	//	WebElement userLogin =driver.findElement(By.xpath("//a[@href='https://login.salesforce.com/']"));
